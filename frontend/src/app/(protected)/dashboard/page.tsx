...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Investment Wealth Advisory Dashboard"
      subtitle="One merged investment wealth advisory view for Portfolios, Clients, Plans, Risk Profiles, Allocations, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared investment wealth advisory jobs into one surface. Portfolios, Clients, Plans, Risk Profiles, Allocations, Rebalancing, documents, audit, and AI are presented as platform features.</div>
