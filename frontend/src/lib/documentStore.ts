...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Portfolios Packet', type: 'Portfolios', owner: 'Advisory Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  ...
  { id: 'doc-3', name: 'Plans Evidence Set', type: 'Plans', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
