export const AUTH_COOKIE = 'investment_wealth_advisory_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@wealth-advisory.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@wealth-advisory.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@wealth-advisory.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
