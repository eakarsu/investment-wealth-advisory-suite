...
PORT="${PORT:-4530}"
DB_NAME="${PGDATABASE:-investment_wealth_advisory_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Investment Wealth Advisory Suite"
echo "======================================="
echo
...
echo "Starting investment wealth advisory suite frontend on http://localhost:$PORT"
echo "Login: admin@wealth-advisory.local / admin123"
